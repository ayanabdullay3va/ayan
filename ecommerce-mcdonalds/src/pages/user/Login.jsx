...
function Login() {
  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      <Grid container component="main" sx={{ height: "40vh",margin:"0" }}>
        <CssBaseline />
        <Grid
          item
          xs={false}
        ...
        />
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square style={{display:"flex",justifyContent:"center"}}>
          <Box
            sx={{
          ...
          >
            ...
            <Box sx={{margin:"0"}}>
              <Formik initialValues={{
                ...
                <Form style={{display:"block",justifyContent:"center",margin:"0"}}>
